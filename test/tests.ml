...
let () =
  print_string "testing NFA acceptance...";
  flush stdout;
  test (string_matcher ~compile:Regex.compile ~accept:nfa_accept);
  print_endline "OK!";

  print_string "testing DFA acceptance...";
  flush stdout;
  test (string_matcher ~compile:dfa_compile ~accept:dfa_accept);
  print_endline "OK!";

  print_string "testing DFA-minimzied acceptance...";
  flush stdout;
  test (string_matcher ~compile:dfa_minimize_compile ~accept:dfa_accept);
  print_endline "OK!"
